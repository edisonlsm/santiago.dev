export default defineI18nLocale(async locale => {
  return {
    hello: "Hello, There!",
    whoAmI: "I'm Edison, a 26 years old geek from Curitiba, Brazil who is always looking forward to improve peoples lives with technology. Software is turning the world into a better place.",
